...
#ifndef GOOGLE_PROTOBUF_INCLUDED_addressbok_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_addressbok_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_addressbok_2eproto
...
struct TableStruct_addressbok_2eproto {
...
/* @@protoc_insertion_point(class_definition:tutorial.Person.PhoneNumber) */ {
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_addressbok_2eproto;
};
// -------------------------------------------------------------------
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_addressbok_2eproto_2epb_2eh

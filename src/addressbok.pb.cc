...
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_addressbok_2eproto[1];
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_addressbok_2eproto = nullptr;
const ::uint32_t
    TableStruct_addressbok_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
...
const char descriptor_table_protodef_addressbok_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\020addressbok.proto\022\010tutorial\"\243\002\n\006Person\022"
...
static ::absl::once_flag descriptor_table_addressbok_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_addressbok_2eproto = {
    false,
    false,
    371,
    descriptor_table_protodef_addressbok_2eproto,
    "addressbok.proto",
    &descriptor_table_addressbok_2eproto_once,
    nullptr,
    0,
    3,
    schemas,
    file_default_instances,
    TableStruct_addressbok_2eproto::offsets,
    file_level_enum_descriptors_addressbok_2eproto,
    file_level_service_descriptors_addressbok_2eproto,
};
namespace tutorial {
const ::google::protobuf::EnumDescriptor* Person_PhoneType_descriptor() {
  ::google::protobuf::internal::AssignDescriptors(&descriptor_table_addressbok_2eproto);
  return file_level_enum_descriptors_addressbok_2eproto[0];
}
...
Person_PhoneNumber::GetClassData() const {
  PROTOBUF_CONSTINIT static const ::google::protobuf::MessageLite::
      ClassDataFull _data_ = {
          ...
          &descriptor_table_addressbok_2eproto,
          nullptr,  // tracker
      };
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_addressbok_2eproto),
         ::std::false_type{});
